...
const icons: IconType[] = [
  {
    icon: "bx:home",
    iconProps: { fontSize: "2rem", style: { marginBottom: 16 } },
  },
  {
    icon: "bx:briefcase",
    iconProps: { fontSize: "2rem", style: { marginBottom: 16 } },
        ...
        <Card>
          ...
          >
            <DialogTitle
              ...
              sx={{ textAlign: "center", fontSize: "1.625rem !important" }}
            >
              {dialogTitle} Card
            </DialogTitle>
            <DialogContent
                  ...
                  <Grid item xs={12} sm={8}>
                    <FormControl fullWidth>
                      ...
                      <Select
                        ...
                        defaultValue={
                          data[cardId].cardStatus ? data[cardId].cardStatus : ""
                        }
                      >
...
export default OrganizationViewBilling;
