...
const OrganizationViewOverview = ({ invoiceData }: Props) => {
  return (
    <Grid container spacing={6}>
      <Typography variant="h5" sx={{ marginInline: "auto", mt: 4 }}>
        Coming soon...
      </Typography>
      {/* <Grid item xs={12}>
            ...
            <Timeline>
              ...
              <TimelineItem>
                ...
                <TimelineContent>
                  ...
                  <AvatarGroup
                    className="pull-up"
                    sx={{ "& .MuiAvatar-root": { width: 38, height: 38 } }}
                  >
...
export default OrganizationViewOverview;
