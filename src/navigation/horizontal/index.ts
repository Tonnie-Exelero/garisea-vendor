          ...
          children: [
            ...
            },
            {
              ...
              children: [
                {
                  title: "Account",
                  path: "/apps/vendor/view/account",
                },
                {
                  title: "Security",
                  path: "/apps/vendor/view/security",
                },
                {
                  title: "Billing & Plans",
                  path: "/apps/vendor/view/billing-plan",
                },
                {
                  title: "Notifications",
                  path: "/apps/vendor/view/notification",
                },
                {
                  title: "Connection",
                  path: "/apps/vendor/view/connection",
                },
              ],
            },
          ],
